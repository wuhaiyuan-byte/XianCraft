...
mod tests {
    ...
    fn test_realm_and_level_up_system() {
        ...
        // Formula: hp = con*10 + 30*realm = 16*10 + 30*1 = 190
        // Formula: atk = 10 + str*2 + realm*5 = 10 + 16*2 + 1*5 = 47
        assert_eq!(initial_hp, 190);
        assert_eq!(initial_atk, 47);
        ...
        assert_eq!(player.atk, 10 + 16 * 2 + 2 * 5); // 52
        ...
        assert_eq!(player.atk, 10 + 16 * 2 + 9 * 5); // 73
