use crate::world_model::{NpcPrototype, NpcZoneData, Room, WorldConfig, ZoneData};
...
pub fn load_all_data(base_path: &str) -> Result<StaticWorldData> {
    ...
    // 3. Load all NPC prototypes from the data directory (npcs.json, etc.)
    ...
    println!("✅ World data loaded: {} rooms, {} NPC prototypes", rooms.len(), npc_prototypes.len());
